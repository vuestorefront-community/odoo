...
::grid{:columns="3"}
#section-1
:card{to="https://redis.io/" title="Redis" description="An in-memory database used to enhance application performance and scalability. In the context of this integration, Redis is employed for html page caching, route caching, stock management and optimizing cart and wishlist read and write operations, reducing backend load and speeding up response times."}

#section-2
:card{to="https://www.algolia.com/" title="Algolia" description="Algolia" description="A search and discovery platform that provides real-time search results and advanced filtering. Algolia is integrated to offer fast and relevant search capabilities on the frontend, with instant and customizable results. It allows for efficient indexing and searching of data such as products and categories."}

#section-3
:card{to="https://www.luigisbox.com" title="Luigi box" description="Algolia" description="Luigi is an eCommerce Search Engine System that provides a powerful and flexible search solution for e-commerce platforms. It is designed to work seamlessly with various e-commerce systems, including Odoo, and can be integrated with Alokai to enhance the search capabilities of online stores."}
